...
public class NdkCxxPlatforms {
  ...
  public static ImmutableMap<TargetCpuType, NdkCxxPlatform> getPlatforms(
    ...
    if (cpuAbis.contains("arm")) {
      String androidPlatform = androidConfig.getNdkAppPlatformForCpuAbi("arm").orElse(NdkCxxPlatforms.DEFAULT_TARGET_APP_PLATFORM);
    ...
    if (cpuAbis.contains("armv7")) {
      String androidPlatform = androidConfig.getNdkAppPlatformForCpuAbi("armv7").orElse(NdkCxxPlatforms.DEFAULT_TARGET_APP_PLATFORM);
      NdkCxxPlatformTargetConfiguration targetConfiguration =
    ...
    if (cpuAbis.contains("arm64")) {
      String androidPlatform = androidConfig.getNdkAppPlatformForCpuAbi("arm64").orElse(NdkCxxPlatforms.DEFAULT_TARGET_APP_PLATFORM);
      NdkCxxPlatformTargetConfiguration targetConfiguration =
    ...
    if (cpuAbis.contains("x86")) {
      String androidPlatform = androidConfig.getNdkAppPlatformForCpuAbi("x86").orElse(NdkCxxPlatforms.DEFAULT_TARGET_APP_PLATFORM);
      NdkCxxPlatformTargetConfiguration targetConfiguration =
    ...
    if (cpuAbis.contains("x86_64")) {
      String androidPlatform = androidConfig.getNdkAppPlatformForCpuAbi("x86_64").orElse(NdkCxxPlatforms.DEFAULT_TARGET_APP_PLATFORM);
      NdkCxxPlatformTargetConfiguration targetConfiguration =
